  ...
  <div class="login_form">
    ...
    <form class="form">
      ...
      <div class="inputForm">
        ...
        <input type="text" class="input" v-model="loginForm.username" placeholder="Enter your Username">
      </div>
      ...
      <div class="inputForm">
        ...
        <input :type="psw" v-model="loginForm.password" class="input" placeholder="Enter your Password">
      ...
      <p class="p">Don't have an account? <span class="span" @click="changeLoginOrRegister">Sign Up</span>
